...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	?>
	<div id="login">
		<h1><p style="color:black;font-size:50px;padding:2%;">Etimder</p><a href="<?php echo esc_url( $login_header_url ); ?>" title="<?php echo esc_attr( $login_header_title ); ?>" tabindex="-1"><?php bloginfo( 'name' ); ?></a></h1>
	<?php
